...
public class DiceSet {
   ...
   */
   public DiceSet( int count, int sides ) {
    // try{
      if (count < 1) {
        throw new IllegalArgumentException("Minimum 1 die.");
      } else {
        ...
        for (int i=0; i < count; i++) {
          ...
          System.out.println(this.ds[i].toString());
        }
        // for (int i = 0; i < count; i++) {
        //   System.out.println(this.ds[i].toString());
        // }
  ...
  //   } catch (IllegalArgumentException e) {throw new IllegalArgumentException("Must be a number");
  // }
}
  /**
