...
public class Clock {
   ...
   */
   ...
   private static double hourAngle = 0;
   private static double minuteAngle = 0;
   ...
   */
   public double getHourHandAngle() {
      this.hourAngle = HOUR_HAND_DEGREES_PER_SECOND * this.seconds;
   ...
   */
   public double getMinuteHandAngle() {
    this.minuteAngle = MINUTE_HAND_DEGREES_PER_SECOND * this.seconds;
   ...
   */
   public double getHandAngle() {
       //absolute value of difference in minute and hour angles
    
    // while(finalAngle != 0){
    //   if()
    //   finalAngle += multipleForWhichWeHaveMoved(minuteHand - )
    // }
    this.angle = Math.abs(getMinuteHandAngle()-getHourHandAngle()) % 360;
    if (this.angle > 180){
   ...
   */
   public String toString() {
      ...
      int hours = (int) this.seconds / 3600 % 12;
      int leftover = (int) this.seconds % 3600;
      ...
      return hString + ":" + minutes + ":" + seconds;
   }
