...
rem @java ClockSolver  -1.0             >> testresults.txt
rem @java ClockSolver   0.0    -1.0     >> testresults.txt
rem @java ClockSolver  90.0     0.0     >> testresults.txt
rem @java ClockSolver 360.0    60.0     >> testresults.txt
rem @java ClockSolver  90.0  1801.0     >> testresults.txt
rem @java ClockSolver  abc              >> testresults.txt
